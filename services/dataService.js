        ...
        return {
            ...
            getData: function (count, alt) {
                ...
                for (var i = 0; i < count; i++) {
                    ...
                    var date = new Date(dt.getFullYear(), i % 12, 25, i % 24, i % 60, i % 60), endDate = new Date(date).setMonth(date.getMonth() + Math.floor(Math.random() * 11)), countryId = Math.floor(Math.random() * countries.length), productId = Math.floor(Math.random() * products.length), colorId = Math.floor(Math.random() * colors.length);
                    // create the item
                    var item = [];
                    if (alt === 1) {
                        item = {
