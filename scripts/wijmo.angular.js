                ...
                switch (metaDataId) {
                    ...
                    case wijmo.grid && wijmo.grid.sheet && wijmo.grid.sheet.FlexSheet:
                        return this.getMetaData(wijmo.grid.FlexGrid).add([
                            ...
                            this.CreateProp('selectedSheetIndex', 1 /* Number */, 1 /* TwoWay */)
                        ], [
                    ...
                    case wijmo.grid && wijmo.grid.sheet && wijmo.grid.sheet.Sheet:
                        return new wijmo.interop.MetaDataBase([
                            this.CreateProp('name', 3 /* String */),
                            this.CreateProp('itemsSource', 8 /* Any */, 0 /* OneWay */, null, false),
                            this.CreateProp('visible', 0 /* Boolean */),
                            this.CreateProp('rowCount', 1 /* Number */, 0 /* OneWay */, null, false),
                            this.CreateProp('columnCount', 1 /* Number */, 0 /* OneWay */, null, false)
                        ], [
                    ...
                    case wijmo.chart && wijmo.chart.finance && wijmo.chart.finance.analytics && wijmo.chart.finance.analytics.Envelopes:
                        return this.getMetaData(wijmo.chart.finance.analytics.OverlayIndicatorBase).add([
                            ...
                            this.CreateProp('type', 5 /* Enum */, 0 /* OneWay */, wijmo.chart.finance.analytics.MovingAverageType)
                        ]);
    ...
    (function (angular) {
        ...
        */
        ...
        var WjSheetLink = (function (_super) {
            ...
            WjSheetLink.prototype._initParent = function () {
                _super.prototype._initParent.call(this);
                var scope = this.scope, flexSheet = this.parent.control;
                if (scope['itemsSource']) {
                    flexSheet.addBoundSheet(scope['name'], scope['itemsSource']);
                } else {
                    flexSheet.addUnboundSheet(scope['name'], +scope['rowCount'], +scope['columnCount']);
                }
            };
            return WjSheetLink;
        })(angular.WjLink);
