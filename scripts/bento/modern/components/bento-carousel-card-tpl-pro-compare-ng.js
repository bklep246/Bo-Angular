/**
 * Bento Carousel Card Tax Provision Compare Template
 *
...
(function () {
  ...
  angular.module('bento.carousel')
    .directive('bentoCarouselCardTplProCompare', function () {
      return {
        scope   : {
          cardData: '=',
          onNewTabClick: '&'
        ...
        '<div class="bento-carousel-card-provision">' +
          ...
          '<div class="content">' +
            ...
            '<div class="right-col">' +
              '<div class="periods">' +
                '<h3 ng-bind="cardData.title_a"></h3>' +
                '<h3 ng-bind="cardData.title_b"></h3>' +
              '</div>' +
              '<ul>' +
