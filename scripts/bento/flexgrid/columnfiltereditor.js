            ...
            var ColumnFilterEditor = (function (_super) {
                ...
                */
                function ColumnFilterEditor(element, filter) {
                    ...
                    */
                    ...
                    /**
                    * BENTO ADDED
                    * Occurs after the select all checkbox clicked.
                    */
                    this.selectAllClicked = new wijmo.Event();
                    /**
                    * BENTO ADDED
                    * Occurs after the select all textbox input changed.
                    */
                    this.filterTextChanged = new wijmo.Event();
                    ...
                    this._btnClose.addEventListener('click', bnd); //BENTO ADDED
                ...
                */
                ColumnFilterEditor.prototype.onFilterChanged = function (e) {
                    ...
                    this.filterChanged.raise({event: e, listCollectionView: this._view});
                };
                ...
                ColumnFilterEditor.prototype._filterTextChanged = function () {
                    ...
                    self._toText = setTimeout(function () {
                        ...
                        self._view.refresh();
                        //BENTO ADDED
                        self.filterTextChanged.raise(self, self._filterText);
                    }, 500);
                };
                ...
                ColumnFilterEditor.prototype._cbSelectAllClicked = function (e) {
                    ...
                    //BENTO ADDED
                    this.selectAllClicked.raise(this, e);
                ...
                // ColumnFilterEditor.controlTemplate = '<div style="padding:6px;min-width:250px">' + '<a wj-part="btn-asc" href="" style="min-width:95px">&#8593; Ascending</a>&nbsp;&nbsp;&nbsp;' + '<a wj-part="btn-dsc" href="" style="min-width:95px">&#8595; Descending</a>' + '<br/>' + '<br/>' + '<div wj-part="div-filter" style="width:100%"></div>' + '<br/>' + '<label class="wj-listbox-item"><input type="checkbox" wj-part="cb-select-all"> Select All</label>' + '<div wj-part="div-values" class="wj-dropdown" style="min-height:90px;max-height:150px;width:100%;margin:0px"></div>' + '<br/>' + '<div style="text-align:right;margin-top:6px">' + '<a wj-part="btn-apply" href="">Apply</a>&nbsp;&nbsp;&nbsp;' + '<a wj-part="btn-clear" href="">Clear</a>' + '</div>';
                //BENTO ADDED - add close button, add class names for custom style
                ColumnFilterEditor.controlTemplate = '<div class="content-cf">' + 
                '<div><span aria-hidden="true" wj-part="btn-close" class="btn btn-close pull-right">&times;</span><span class="sr-only">close</span></div><br clear="both"><hr>' + 
                '<a wj-part="btn-asc" class="btn-cf" href=""><span class="bento-icon-thin-arrow2-up"></span>Ascending</a>' + 
                '<a wj-part="btn-dsc" class="btn-cf" href=""><span class="bento-icon-thin_arrow2_down"></span>Descending</a>' + 
                '<hr>' + '<div class="filter-container"><div wj-part="div-filter" class="filter"></div></div>' + '<hr>' + 
                '<label class="wj-listbox-item"><input type="checkbox" wj-part="cb-select-all"> Select All</label>' + 
                '<div wj-part="div-values" class="wj-dropdown" style="min-height:90px;max-height:250px;width:100%;margin:0px"></div>' + 
                '<hr>' + '<div class="btn-forms">' + '<a wj-part="btn-apply" href="" class="btn btn-primary">Apply</a>' + 
                '<a wj-part="btn-clear" href="" class="btn btn-default">Clear</a>' + '</div>';
